...
### Лаунчер откроется автоматически 



### Адрес для работы в браузере
```
http://localhost:8000
```

**Для сотрудников:**  Адрес подключения будет виден при запуске на главной странице
...
- **Экономия времени** администратора(наладчика) 10-15 часов/неделю
...
├── ⚙️ dist/activity-logger.js       # Логгер действий
...
> 📞 **Бесплатная консультация по лицензированию:** toolmngs@gmail.com
